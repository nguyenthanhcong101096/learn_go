...
var file_chat_proto_rawDesc = []byte{
	...
	,
...
var file_chat_proto_goTypes = []interface{}{
	(*String)(nil), // 0: chat.String
}
var file_chat_proto_depIdxs = []int32{
	0, // 0: chat.HelloService.Hello:input_type -> chat.String
	0, // 1: chat.HelloService.Channel:input_type -> chat.String
	0, // 2: chat.HelloService.Hello:output_type -> chat.String
	0, // 3: chat.HelloService.Channel:output_type -> chat.String
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/chat.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/chat.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.HelloService/Hello",
	}
